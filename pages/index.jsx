  ...
  return (
    <>
      ...
      <div className="bg-black text-text-base antialiased font-sans">
        ...
        {/* Header (mobile: only Get a Quote; desktop: both CTAs) */}
        ...
        <section id="top" className="py-20 md:py-28 bg-black">
          <div className="mx-auto max-w-7xl px-6 md:px-12 grid md:grid-cols-12 gap-10 items-center">
            <div className="md:col-span-7 space-y-8">
              <span className="inline-flex items-center rounded-full px-4 py-2 text-sm font-bold bg-dark-soft text-white ring-1 ring-lime-neon/30">
                VEU-Accredited Upgrades
              </span>
              <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight text-white">
                Take Advantage of Up to $9,900 in VEU Incentives
              </h1>
              <p className="text-xl md:text-2xl font-medium text-text-soft">
              ...
              <ul className="grid grid-cols-2 md:grid-cols-4 gap-6 text-lg">
                {[
                  ...
                  <li key={i} className="bg-dark-soft rounded-lg shadow-md ring-1 ring-[#1f1f1f] p-4 text-center">
                    <strong className="block text-xl font-bold text-white">{t}</strong>
                    <span className="text-base text-text-soft">{s}</span>
                  </li>
                ))}
              </ul>
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
              {["gif1.gif", "gif2.gif", "gif3.gif", "gif4.gif"].map((g, i) => (
                <div key={i} className="bg-dark-soft rounded-2xl shadow-lg ring-1 ring-[#1f1f1f] p-6">
                  <img
                    src={`/${g}`}
                    alt={`Animation ${i + 1}`}
        ...
        <section aria-label="Trust and Accreditation" className="py-10 bg-black border-y border-dark-border">
          <div className="mx-auto max-w-7xl px-6 md:px-12 flex flex-wrap items-center justify-center gap-8">
            ...
            <span className="text-base font-medium text-text-soft">
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <article className="bg-dark-soft rounded-2xl shadow-lg ring-1 ring-[#1f1f1f] p-6 hover:shadow-xl transition-shadow">
                <Carousel
                  images={["/IMG_5167.webp", "/IMG_5166.webp", "/IMG_5165.webp"]}
                  altBase="Emerald Split System"
                />
                <h3 className="text-2xl font-bold text-white mb-4">Emerald Split System</h3>
                <p className="text-lg font-medium text-text-soft mb-4">
              ...
              <article className="bg-dark-soft rounded-2xl shadow-lg ring-1 ring-[#1f1f1f] p-6 hover:shadow-xl transition-shadow">
                <img
                  ...
                  loading="lazy"
                />
                <h3 className="text-2xl font-bold text-white mb-4">Avanti PLUS® Series</h3>
                <p className="text-lg font-medium text-text-soft mb-4">
              ...
              <article className="bg-dark-soft rounded-2xl shadow-lg ring-1 ring-[#1f1f1f] p-6 hover:shadow-xl transition-shadow">
                <img
                  ...
                  loading="lazy"
                />
                <h3 className="text-2xl font-bold text-white mb-4">Rinnai T Series</h3>
                <p className="text-lg font-medium text-text-soft mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-dark-soft text-white rounded-2xl shadow-lg ring-1 ring-[#1f1f1f] p-6">
                ...
                <ul className="space-y-6 text-lg leading-relaxed">
                  ...
                  <li><span className="text-lime-neon font-semibold">✅ Emerald Energy 270L/320L</span><br />Wi-Fi, 6-yr warranty.</li>
                  <li><span className="text-lime-neon font-semibold">✅ EcoGenica Split</span><br />215L, 260L, 290L, 7-yr warranty.</li>
                </ul>
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-12">
            ...
            <div className="bg-dark-soft text-white rounded-2xl shadow-lg ring-1 ring-[#1f1f1f] p-6">
              ...
              <ul className="space-y-6 text-lg leading-relaxed">
                ...
                <li><span className="text-lime-neon font-semibold">✅ CER STCs</span><br />System must meet efficiency standards.</li>
                <li><span className="text-lime-neon font-semibold">✅ SolarVic Rebate</span><br />Income &lt; $210K, home &lt; $3M, system &gt; 3 years old.</li>
              </ul>
              <a
                href="#contact"
        ...
        <section id="contact" className="py-20 md:py-24 bg-black">
          <div className="mx-auto max-w-4xl px-6 md:px-12 text-center">
            ...
            <p className="text-xl font-medium text-text-soft mb-6">
              Free inspections available across Victoria. Rebates apply now for heating, cooling, and hot water upgrades.
            </p>

            <form className="bg-dark-soft rounded-2xl shadow-lg ring-1 ring-[#1f1f1f] p-6 grid md:grid-cols-2 gap-6 text-left">
              <label className="block">
                <span className="text-base font-bold text-white">Full Name</span>
                <input type="text" required className="mt-2 w-full rounded-lg border-[#242424] focus:border-lime-neon focus:ring-lime-neon p-3 bg-black text-text-base" placeholder="Jane Citizen" />
              </label>
              <label className="block">
                <span className="text-base font-bold text-white">Email</span>
                <input type="email" required className="mt-2 w-full rounded-lg border-[#242424] focus:border-lime-neon focus:ring-lime-neon p-3 bg-black text-text-base" placeholder="jane@email.com" />
              </label>
              <label className="block md:col-span-2">
                <span className="text-base font-bold text-white">Postcode</span>
                <input type="text" required className="mt-2 w-full rounded-lg border-[#242424] focus:border-lime-neon focus:ring-lime-neon p-3 bg-black text-text-base" placeholder="3000" />
              </label>
              <label className="block md:col-span-2">
                <span className="text-base font-bold text-white">Message</span>
                <textarea rows={5} required className="mt-2 w-full rounded-lg border-[#242424] focus:border-lime-neon focus:ring-lime-neon p-3 bg-black text-text-base" placeholder="How can we assist you?" />
              </label>
        ...
        <section className="w-full py-16 md:py-20 bg-black border-t border-dark-border">
          <div className="max-w-4xl mx-auto px-6">
            <div className="bg-dark-soft rounded-2xl shadow-lg overflow-hidden ring-1 ring-[#1f1f1f]">
        ...
        <footer className="py-10 bg-black border-t border-dark-border text-white">
          <div className="mx-auto max-w-7xl px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6 text-lg">
            ...
            <div className="flex items-center gap-6">
              ...
              <span className="text-white/30">•</span>
              <a href="mailto:contact@GLEnergy.com.au" className="hover:text-lime-neon transition-colors">
                Contact
              </a>
            </div>
          </div>
